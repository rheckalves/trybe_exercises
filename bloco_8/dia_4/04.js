...
const isBornInTwentyCentury = year => year < 2000 && year >= 1900;
const filterPeople = people => people.filter(({bornIn, nationality}) => isAustralian(nationality) && isBornInTwentyCentury(bornIn));
